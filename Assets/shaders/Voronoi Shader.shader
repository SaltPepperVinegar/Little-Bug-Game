...
Shader "Unlit/point Shader"
{
    Properties
    {
        ...
        _motionAmplitude("motion amplitude", Float) = 1.0
        _motionFrequency("motion frequency", Float) = 1.0
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float brownianMotion(float x)
            {
                ...
                float amplitude = x * _motionAmplitude;
                float frequency = x * _motionFrequency;
